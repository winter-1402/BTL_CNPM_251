...
(N'Nguyễn Văn An', N'an.nguyen@hcmut.edu.vn', N'student123' , N'student'),
(N'Bùi Tuấn Cươgng', N'cuong.0707@hcmut.edu.vn', N'07072005' , N'student'),
(N'TS. Trần Văn Minh', N'minh.tran@hcmut.edu.vn', N'tutor123' , N'tutor'),
(N'TS. Hùynh Duy Chương', N'chuong@hcmut.edu.vn', N'123@a' , N'tutor'),
(N'Quản trị viên Hệ thống', N'admin@hcmut.edu.vn', N' admin123' , N'admin'),
(N'Hoàng Văn Khánh', N'khanh.hoang@hcmut.edu.vn', N'07072005' , N'student'),
(N'Võ Thị Lan', N'lan.vo@hcmut.edu.vn', N'student234' , N'student'),
(N'Lê Thị Mai', N'mai.le@hcmut.edu.vn', N'student567' , N'student'),
(N'Trần Văn Đức', N'duc.tran@hcmut.edu.vn', N'student789' , N'student'),
(N'PhD. Nguyễn Thành Long', N'long.nguyen@hcmut.edu.vn', N'tutor123' , N'tutor'),
(N'MSC. Lê Thị Hoa', N'hoa.le@hcmut.edu.vn', N'123@a' , N'tutor'),
(N'TS. Hoàng Văn Khánh ', N'khanh.hoang1@hcmut.edu.vn', N'tutor123' , N'tutor'),
(N'MSC. Phạm Thị Lan', N'lan@hcmut.edu.vn', N'123@a' , N'tutor')
GO
...
(0,N'Thứ Hai 14:00','16:00'),
(0,N'Thứ Tư 10:00','12:00'),
(0,N'Thứ Sáu 15:00','17:00'),
(1,N'Thứ Ba 16:00','18:00'),
(1,N'Thứ Năm 9:00','11:00'),
(1,N'Thứ Sáu 7:00','9:00')
GO

INSERT INTO booked (availability_Id, student_id,  booked_types, topic) VALUES
(0,2,N'Trực Tiếp',N'Học Máy'),
(2,4,N'Trực Tuyến',N'Cấu Trúc Dữ Liệu'),
(3,3,N'Trực Tuyến',N'Thuật Toán'),
(4,2,N'Trực Tiếp',N'Công nghệ phần mềm')
GO
