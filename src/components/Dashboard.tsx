...
export function Dashboard({ user }: DashboardProps) {
  ...
  const stats = [
    { label: 'Tổng số buổi học', value: '24', icon: Calendar, color: 'bg-blue-500' },
    { label: 'Giờ học', value: '36', icon: Clock, color: 'bg-green-500' },
    { label: 'Đánh giá trung bình', value: '4.8', icon: Star, color: 'bg-yellow-500' },
    { label: 'Gia sư đang học', value: '3', icon: Users, color: 'bg-purple-500' },
  ];
              ...
              <div key={index} className="space-y-2">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-900">{course.course}</span>
                  </div>
                  <span className="text-sm text-gray-500">{course.sessions} buổi học</span>
                </div>
