...
export function Reports({ user }: ReportsProps) {
  ...
  const topTutors = [
    ...
    { name: 'PhD. Nguyen Thanh Long', sessions: 142, rating: 4.9, students: 38 },
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-gray-200">
                  ...
                  <th className="text-left py-3 px-4 text-sm text-gray-600">Sessions</th>
              ...
              <tbody>
                {topTutors.map((tutor, index) => (
                  <tr key={index} className="border-b border-gray-100">
                    ...
                    <td className="py-3 px-4 text-gray-600">{tutor.sessions}</td>
                    <td className="py-3 px-4 text-gray-600">{tutor.students}</td>
                    <td className="py-3 px-4">
